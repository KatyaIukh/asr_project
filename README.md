...
<img width="700" alt="Снимок экрана (3082)" src="https://github.com/user-attachments/assets/ec2a9ebf-7a9d-4e0b-90fd-90294d86ec93" />
...
- **`json_from_common.ipynb`** - преобразование данных из формата архива Common Voice в JSON

### 📁 Данные
- **`sorbian_train.json`** - тренировочные данные на верхнелужицком языке из Common Voice
- **`sorbian_val.json`** - валидационные данные на верхнелужицком языке из Common Voice

### 🚀 Код обучения адаптеров
- **`base_adapter_train.py`** - обучение базового чешского адаптера
- **`hsb_adapter.py`** - обучение верхнелужицкого адаптера (классический подход)
- **`cz_hsb_adapter.py`** - обучение верхнелужицкого адаптера с использованием чешского адаптера (двуэтапный подход)
